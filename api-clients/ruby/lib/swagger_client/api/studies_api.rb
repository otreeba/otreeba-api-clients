...
module SwaggerClient
  class StudiesApi
    ...
    def get_studies_by_condition_with_http_info(condition_slug, opts = {})
      ...
      if @api_client.config.client_side_validation && condition_slug.nil?
        fail ArgumentError, "Missing the required parameter 'condition_slug' when calling StudiesApi.get_studies_by_condition"
      end
      if @api_client.config.client_side_validation && opts[:'sort'] && !['-year', 'year', '-createdAt', 'createdAt', '-updatedAt', 'updatedAt'].include?(opts[:'sort'])
        fail ArgumentError, 'invalid value for "sort", must be one of -year, year, -createdAt, createdAt, -updatedAt, updatedAt'
      end
      # resource path
      local_var_path = "/studies/conditions/{conditionSlug}".sub('{' + 'conditionSlug' + '}', condition_slug.to_s)
    ...
    def get_studies_conditions_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/studies/conditions"
    ...
    def get_study_by_identifier_with_http_info(identifier_type, identifier, opts = {})
      ...
      if @api_client.config.client_side_validation && identifier_type.nil?
        fail ArgumentError, "Missing the required parameter 'identifier_type' when calling StudiesApi.get_study_by_identifier"
      end
      # verify enum value
      if @api_client.config.client_side_validation && !['doi', 'pubMedId', 'slug'].include?(identifier_type)
        fail ArgumentError, "invalid value for 'identifier_type', must be one of doi, pubMedId, slug"
      end
      # verify the required parameter 'identifier' is set
      if @api_client.config.client_side_validation && identifier.nil?
        fail ArgumentError, "Missing the required parameter 'identifier' when calling StudiesApi.get_study_by_identifier"
      end
      # resource path
      local_var_path = "/studies/{identifierType}/{identifier}".sub('{' + 'identifierType' + '}', identifier_type.to_s).sub('{' + 'identifier' + '}', identifier.to_s)
