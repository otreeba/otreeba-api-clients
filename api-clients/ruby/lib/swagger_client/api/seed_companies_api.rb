  ...
  class SeedCompaniesApi
    ...
    def get_seed_company_by_ocpc_with_http_info(ocpc, opts = {})
      ...
      if @api_client.config.client_side_validation && ocpc.nil?
        fail ArgumentError, "Missing the required parameter 'ocpc' when calling SeedCompaniesApi.get_seed_company_by_ocpc"
      end
      # resource path
      local_var_path = "/seed-companies/{ocpc}".sub('{' + 'ocpc' + '}', ocpc.to_s)
    ...
    def get_seed_company_strains_by_ocpc_with_http_info(ocpc, opts = {})
      ...
      # verify the required parameter 'ocpc' is set
      if @api_client.config.client_side_validation && ocpc.nil?
        fail ArgumentError, "Missing the required parameter 'ocpc' when calling SeedCompaniesApi.get_seed_company_strains_by_ocpc"
      end
      # resource path
      local_var_path = "/seed-companies/{ocpc}/strains".sub('{' + 'ocpc' + '}', ocpc.to_s)
