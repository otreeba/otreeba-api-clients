  ...
  class StrainsApi
    ...
    def get_strain_by_ocpc_with_http_info(ocpc, opts = {})
      ...
      if @api_client.config.client_side_validation && ocpc.nil?
        fail ArgumentError, "Missing the required parameter 'ocpc' when calling StrainsApi.get_strain_by_ocpc"
      end
      # resource path
      local_var_path = "/strains/{ocpc}".sub('{' + 'ocpc' + '}', ocpc.to_s)
