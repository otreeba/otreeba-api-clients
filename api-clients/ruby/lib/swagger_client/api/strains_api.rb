...
module SwaggerClient
  class StrainsApi
    ...
    # @return [Strain]
    def get_strain_by_ocpc(ocpc, opts = {})
      data, _status_code, _headers = get_strain_by_ocpc_with_http_info(ocpc, opts)
      return data
    end
    ...
    # @param ocpc OCPC of the strain to return.
    # @param [Hash] opts the optional parameters
    # @return [Array<(Strain, Fixnum, Hash)>] Strain data, response status code and response headers
    def get_strain_by_ocpc_with_http_info(ocpc, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StrainsApi.get_strain_by_ocpc ..."
      end
      # verify the required parameter 'ocpc' is set
      fail ArgumentError, "Missing the required parameter 'ocpc' when calling StrainsApi.get_strain_by_ocpc" if ocpc.nil?
      # resource path
      local_var_path = "/strains/{ocpc}".sub('{format}','json').sub('{' + 'ocpc' + '}', ocpc.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'Strain')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StrainsApi#get_strain_by_ocpc\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_strains(opts = {})
      data, _status_code, _headers = get_strains_with_http_info(opts)
      return data
    end
    ...
    def get_strains_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: StrainsApi.get_strains ..."
      end
      ...
      # resource path
      local_var_path = "/strains".sub('{format}','json')
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StrainsApi#get_strains\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
