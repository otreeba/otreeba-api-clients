...
class EdiblesApi(val defBasePath: String = "https://api.otreeba.com/v1",
   ...
   * @return Edible
   */
  def getEdibleByOcpc(ocpc: String): Option[Edible] = {
    // create path and map variables
    val path = "/edibles/{ocpc}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "ocpc" + "\\}",apiInvoker.escape(ocpc))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(apiInvoker.deserialize(s, "", classOf[Edible]).asInstanceOf[Edible])
        case _ => None
      }
    } catch {
   ...
   */
  def getEdibles(page: Option[Integer] = None, count: Option[Integer] /* = 10*/, sort: Option[String] /* = -createdAt*/): Option[InlineResponse2002] = {
    // create path and map variables
    val path = "/edibles".replaceAll("\\{format\\}", "json")
