...
class ProductsApi(object):
    ...
    def get_product_by_ocpc(self, ocpc, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_product_by_ocpc(ocpc, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str ocpc: OCPC of the product to return. (required)
        :return: Product
        ...
        if kwargs.get('callback'):
            return self.get_product_by_ocpc_with_http_info(ocpc, **kwargs)
        else:
            (data) = self.get_product_by_ocpc_with_http_info(ocpc, **kwargs)
            return data

    def get_product_by_ocpc_with_http_info(self, ocpc, **kwargs):
        """
        Find product by Open Cannabis Product Code (OCPC).
        Returns a single product.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_product_by_ocpc_with_http_info(ocpc, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_product_by_ocpc" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'ocpc' is set
        if ('ocpc' not in params) or (params['ocpc'] is None):
            raise ValueError("Missing the required parameter `ocpc` when calling `get_product_by_ocpc`")
        ...
        return self.api_client.call_api('/products/{ocpc}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
