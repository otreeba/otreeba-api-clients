...
class ExtractsApi(object):
    ...
    def get_extract_by_ocpc(self, ocpc, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_extract_by_ocpc(ocpc, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str ocpc: OCPC of the extract to return. (required)
        :return: Extract
        ...
        if kwargs.get('callback'):
            return self.get_extract_by_ocpc_with_http_info(ocpc, **kwargs)
        else:
            (data) = self.get_extract_by_ocpc_with_http_info(ocpc, **kwargs)
            return data

    def get_extract_by_ocpc_with_http_info(self, ocpc, **kwargs):
        """
        Find extract by Open Cannabis Product Code (OCPC).
        Returns a single extract.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_extract_by_ocpc_with_http_info(ocpc, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_extract_by_ocpc" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'ocpc' is set
        if ('ocpc' not in params) or (params['ocpc'] is None):
            raise ValueError("Missing the required parameter `ocpc` when calling `get_extract_by_ocpc`")
        ...
        return self.api_client.call_api('/extracts/{ocpc}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_extracts_with_http_info(self, **kwargs):
        ...
        return self.api_client.call_api('/extracts', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
