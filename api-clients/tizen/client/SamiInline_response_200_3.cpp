...
SamiInline_response_200_3::fromJsonObject(IJsonValue* pJson) {
    ...
    if(pJsonObject != null) {
        ...
        if(pMetaVal != null) {
            ...
            pMeta = new SamiInline_response_200_3_meta();
            jsonToValue(pMeta, pMetaVal, L"SamiInline_response_200_3_meta", L"SamiInline_response_200_3_meta");
        }
        delete pMetaKey;
    }
}
...
SamiInline_response_200_3::asJsonObject() {
    ...
    JsonString *pMetaKey = new JsonString(L"meta");
    pJsonObject->Add(pMetaKey, toJson(getPMeta(), "SamiInline_response_200_3_meta", ""));
...
void
SamiInline_response_200_3::setPMeta(SamiInline_response_200_3_meta* pMeta) {
    this->pMeta = pMeta;
}
