...
SamiEdible*
SamiEdible::fromJson(String* json) {
    this->cleanup();
...
void
SamiEdible::fromJsonObject(IJsonValue* pJson) {
...
SamiEdible::SamiEdible(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
void
SamiEdible::setPName(String* pName) {
    this->pName = pName;
}
...
void
SamiEdible::setPOcpc(String* pOcpc) {
    this->pOcpc = pOcpc;
}

SamiObject*
SamiEdible::getPBrand() {
    return pBrand;
}
void
SamiEdible::setPBrand(SamiObject* pBrand) {
    this->pBrand = pBrand;
}
...
void
SamiEdible::setPType(String* pType) {
    this->pType = pType;
}

SamiObject*
SamiEdible::getPStrain() {
    return pStrain;
}
void
SamiEdible::setPStrain(SamiObject* pStrain) {
    this->pStrain = pStrain;
}

String*
SamiEdible::getPDescription() {
    return pDescription;
}
void
SamiEdible::setPDescription(String* pDescription) {
...
void
SamiEdible::setPUrl(String* pUrl) {
    this->pUrl = pUrl;
}

String*
SamiEdible::getPImage() {
    return pImage;
}
void
SamiEdible::setPImage(String* pImage) {
    this->pImage = pImage;
}

String*
SamiEdible::getPLabTest() {
    return pLabTest;
}
void
SamiEdible::setPLabTest(String* pLabTest) {
...
void
SamiEdible::setPThc(String* pThc) {
    this->pThc = pThc;
}
...
void
SamiEdible::setPCbd(String* pCbd) {
    this->pCbd = pCbd;
}

String*
SamiEdible::getPCannabis() {
    return pCannabis;
}
void
SamiEdible::setPCannabis(String* pCannabis) {
    this->pCannabis = pCannabis;
}

String*
SamiEdible::getPHashOil() {
    return pHashOil;
}
void
SamiEdible::setPHashOil(String* pHashOil) {
    this->pHashOil = pHashOil;
}

DateTime*
SamiEdible::getPCreatedAt() {
    return pCreatedAt;
}
void
SamiEdible::setPCreatedAt(DateTime* pCreatedAt) {
    this->pCreatedAt = pCreatedAt;
}

DateTime*
SamiEdible::getPUpdatedAt() {
    return pUpdatedAt;
}
void
SamiEdible::setPUpdatedAt(DateTime* pUpdatedAt) {
