...
#
package WWW::SwaggerClient::FlowersApi;
...
# @param string $ocpc OCPC of the flower to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_flower_by_ocpc' } = { 
...
# @return Flower
#
sub get_flower_by_ocpc {
    my ($self, %args) = @_;

    # verify the required parameter 'ocpc' is set
    unless (exists $args{'ocpc'}) {
      croak("Missing the required parameter 'ocpc' when calling get_flower_by_ocpc");
    }

    # parse inputs
    my $_resource_path = '/flowers/{ocpc}';
    ...
    my $_response_object = $self->{api_client}->deserialize('Flower', $response);
...
# @param string $sort How to sort the items. (optional, default to -createdAt)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_flowers' } = { 
