...
#
package WWW::SwaggerClient::Object::InlineResponse2001Meta;
...
__PACKAGE__->class_documentation({description => 'Gets the Strains for a Seed Company listing from a given OCPC.',
