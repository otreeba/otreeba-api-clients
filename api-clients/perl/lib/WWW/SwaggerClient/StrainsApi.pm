...
#
package WWW::SwaggerClient::StrainsApi;
...
# @param string $ocpc OCPC of the strain to return. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_strain_by_ocpc' } = { 
...
# @return Strain
#
sub get_strain_by_ocpc {
    my ($self, %args) = @_;

    # verify the required parameter 'ocpc' is set
    unless (exists $args{'ocpc'}) {
      croak("Missing the required parameter 'ocpc' when calling get_strain_by_ocpc");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('Strain', $response);
...
# @param string $sort How to sort the items. (optional, default to -createdAt)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_strains' } = { 
