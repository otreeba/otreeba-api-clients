...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Brand', 'model/Condition', 'model/Edible', 'model/Error', 'model/Extract', 'model/Flower', 'model/InlineResponse200', 'model/InlineResponse2001', 'model/InlineResponse20010', 'model/InlineResponse20011', 'model/InlineResponse20012', 'model/InlineResponse20013', 'model/InlineResponse2001Meta', 'model/InlineResponse2002', 'model/InlineResponse2003', 'model/InlineResponse2004', 'model/InlineResponse2005', 'model/InlineResponse2006', 'model/InlineResponse2007', 'model/InlineResponse2008', 'model/InlineResponse2009', 'model/Meta', 'model/Pagination', 'model/Product', 'model/SeedCompany', 'model/Strain', 'model/Study', 'api/BrandsApi', 'api/EdiblesApi', 'api/ExtractsApi', 'api/FlowersApi', 'api/ProductsApi', 'api/SeedCompaniesApi', 'api/StrainsApi', 'api/StudiesApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/Brand'), require('./model/Condition'), require('./model/Edible'), require('./model/Error'), require('./model/Extract'), require('./model/Flower'), require('./model/InlineResponse200'), require('./model/InlineResponse2001'), require('./model/InlineResponse20010'), require('./model/InlineResponse20011'), require('./model/InlineResponse20012'), require('./model/InlineResponse20013'), require('./model/InlineResponse2001Meta'), require('./model/InlineResponse2002'), require('./model/InlineResponse2003'), require('./model/InlineResponse2004'), require('./model/InlineResponse2005'), require('./model/InlineResponse2006'), require('./model/InlineResponse2007'), require('./model/InlineResponse2008'), require('./model/InlineResponse2009'), require('./model/Meta'), require('./model/Pagination'), require('./model/Product'), require('./model/SeedCompany'), require('./model/Strain'), require('./model/Study'), require('./api/BrandsApi'), require('./api/EdiblesApi'), require('./api/ExtractsApi'), require('./api/FlowersApi'), require('./api/ProductsApi'), require('./api/SeedCompaniesApi'), require('./api/StrainsApi'), require('./api/StudiesApi'));
  }
}(function(ApiClient, Brand, Condition, Edible, Error, Extract, Flower, InlineResponse200, InlineResponse2001, InlineResponse20010, InlineResponse20011, InlineResponse20012, InlineResponse20013, InlineResponse2001Meta, InlineResponse2002, InlineResponse2003, InlineResponse2004, InlineResponse2005, InlineResponse2006, InlineResponse2007, InlineResponse2008, InlineResponse2009, Meta, Pagination, Product, SeedCompany, Strain, Study, BrandsApi, EdiblesApi, ExtractsApi, FlowersApi, ProductsApi, SeedCompaniesApi, StrainsApi, StudiesApi) {
  'use strict';
