...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtreebaOpenCannabisApi.ExtractsApi();
  });
  ...
  describe('ExtractsApi', function() {
    describe('getExtractByOcpc', function() {
      it('should call getExtractByOcpc successfully', function(done) {
        //uncomment below and update the code to test getExtractByOcpc
        //instance.getExtractByOcpc(function(error) {
