...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtreebaOpenCannabisApi.Flower();
  });
  ...
  describe('Flower', function() {
    it('should create an instance of Flower', function() {
      // uncomment below and update the code to test Flower
      //var instane = new OtreebaOpenCannabisApi.Flower();
      //expect(instance).to.be.a(OtreebaOpenCannabisApi.Flower);
    });
