...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OtreebaOpenCannabisApi.Strain();
  });
  ...
  describe('Strain', function() {
    it('should create an instance of Strain', function() {
      ...
      //var instane = new OtreebaOpenCannabisApi.Strain();
      //expect(instance).to.be.a(OtreebaOpenCannabisApi.Strain);
    });
    ...
    it('should have the property seedCompany (base name: "seedCompany")', function() {
      // uncomment below and update the code to test the property seedCompany
      //var instane = new OtreebaOpenCannabisApi.Strain();
      //expect(instance).to.be();
    });
