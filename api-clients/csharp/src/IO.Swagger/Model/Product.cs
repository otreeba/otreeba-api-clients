...
namespace IO.Swagger.Model
{
    ...
    public partial class Product :  IEquatable<Product>, IValidatableObject
    {
        ...
        /// <param name="Ocpc">Open Cannabis Product Code for the product..</param>
        /// <param name="Brand">Name and Open Cannabis Product Code of the brand that created this product..</param>
        /// <param name="Type">Type of product..</param>
        /// <param name="Strain">Name and Open Cannabis Product Code of the strain for this product..</param>
        /// <param name="Description">Description of the product..</param>
        /// <param name="Qr">URL for QR that leads to page on Cannabis Reports..</param>
        /// <param name="Url">URL for the product on Cannabis Reports..</param>
        /// <param name="Image">URL for the main photo of the product..</param>
        /// <param name="LabTest">URL for the PDF containing lab testing information for this product..</param>
        /// <param name="Thc">THC measurement for this product..</param>
        /// <param name="Cbd">CBD measurement for this product..</param>
        /// <param name="Cannabis">Cannabis measurement for this product..</param>
        /// <param name="HashOil">Hash oil measurement for this product..</param>
        ...
        public Product(string Name = default(string), string Ocpc = default(string), Object Brand = default(Object), string Type = default(string), Object Strain = default(Object), string Description = default(string), string Qr = default(string), string Url = default(string), string Image = default(string), string LabTest = default(string), string Thc = default(string), string Cbd = default(string), string Cannabis = default(string), string HashOil = default(string), DateTime? CreatedAt = default(DateTime?), DateTime? UpdatedAt = default(DateTime?))
        {
