...
class ExtractsApi
{
     ...
     *
     * @param string $ocpc OCPC of the extract to return. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\Extract
     */
    public function getExtractByOcpc($ocpc)
    {
        list($response) = $this->getExtractByOcpcWithHttpInfo($ocpc);
        return $response;
    }

    /**
     * Operation getExtractByOcpcWithHttpInfo
     *
     * Find extract by Open Cannabis Product Code (OCPC).
     *
     * @param string $ocpc OCPC of the extract to return. (required)
     ...
     */
    public function getExtractByOcpcWithHttpInfo($ocpc)
    {
        // verify the required parameter 'ocpc' is set
        if ($ocpc === null) {
            throw new \InvalidArgumentException('Missing the required parameter $ocpc when calling getExtractByOcpc');
        }
        // parse inputs
        $resourcePath = "/extracts/{ocpc}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\Extract', $httpHeader), $statusCode, $httpHeader];
     ...
     */
    public function getExtracts($page = null, $count = '10', $sort = '-createdAt')
    {
        list($response) = $this->getExtractsWithHttpInfo($page, $count, $sort);
        return $response;
    }
     ...
     */
    public function getExtractsWithHttpInfo($page = null, $count = '10', $sort = '-createdAt')
    {
        // parse inputs
