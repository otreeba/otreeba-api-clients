...
SWGInline_response_200::init() {
    meta = new SWGInline_response_200_meta();
}
...
SWGInline_response_200::fromJsonObject(QJsonObject &pJson) {
    ::Swagger::setValue(&meta, pJson["meta"], "SWGInline_response_200_meta", "SWGInline_response_200_meta");
}
...
SWGInline_response_200::asJsonObject() {
    ...
    toJsonValue(QString("meta"), meta, obj, QString("SWGInline_response_200_meta"));
...
void
SWGInline_response_200::setMeta(SWGInline_response_200_meta* meta) {
    this->meta = meta;
}
