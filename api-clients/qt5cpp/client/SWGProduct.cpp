...
void
SWGProduct::setOcpc(QString* ocpc) {
    this->ocpc = ocpc;
}
...
void
SWGProduct::setBrand(SWGObject* brand) {
    this->brand = brand;
}
...
SWGObject*
SWGProduct::getStrain() {
    return strain;
}
void
SWGProduct::setStrain(SWGObject* strain) {
    this->strain = strain;
}
...
void
SWGProduct::setImage(QString* image) {
    this->image = image;
}

QString*
SWGProduct::getLabTest() {
    return lab_test;
}
void
SWGProduct::setLabTest(QString* lab_test) {
...
void
SWGProduct::setCbd(QString* cbd) {
    this->cbd = cbd;
}

QString*
SWGProduct::getCannabis() {
    return cannabis;
}
void
SWGProduct::setCannabis(QString* cannabis) {
    this->cannabis = cannabis;
}

QString*
SWGProduct::getHashOil() {
    return hash_oil;
}
void
SWGProduct::setHashOil(QString* hash_oil) {
    this->hash_oil = hash_oil;
}

QDateTime*
SWGProduct::getCreatedAt() {
    return created_at;
}
void
SWGProduct::setCreatedAt(QDateTime* created_at) {
    this->created_at = created_at;
}

QDateTime*
SWGProduct::getUpdatedAt() {
    return updated_at;
}
void
SWGProduct::setUpdatedAt(QDateTime* updated_at) {
