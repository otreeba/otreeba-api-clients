...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<Inline_response_200_3_meta> getMeta() const;
    void setMeta(std::shared_ptr<Inline_response_200_3_meta> value);
    bool metaIsSet() const;
    void unsetMeta();

protected:
    std::shared_ptr<Inline_response_200_3_meta> m_Meta;
    bool m_MetaIsSet;
};
