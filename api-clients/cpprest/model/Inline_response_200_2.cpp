...
void Inline_response_200_2::fromJson(web::json::value& val)
{
    if(val.has_field(U("meta")))
    {
        ...
        {
            std::shared_ptr<Inline_response_200_2_meta> newItem(new Inline_response_200_2_meta());
...
std::shared_ptr<Inline_response_200_2_meta> Inline_response_200_2::getMeta() const
{
    return m_Meta;
}
void Inline_response_200_2::setMeta(std::shared_ptr<Inline_response_200_2_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
