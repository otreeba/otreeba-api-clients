...
void Inline_response_200_8::fromJson(web::json::value& val)
{
    if(val.has_field(U("meta")))
    {
        ...
        {
            std::shared_ptr<Inline_response_200_8_meta> newItem(new Inline_response_200_8_meta());
...
std::shared_ptr<Inline_response_200_8_meta> Inline_response_200_8::getMeta() const
{
    return m_Meta;
}
void Inline_response_200_8::setMeta(std::shared_ptr<Inline_response_200_8_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
bool Inline_response_200_8::metaIsSet() const
{
    return m_MetaIsSet;
}
void Inline_response_200_8::unsetMeta()
{
    m_MetaIsSet = false;
}
