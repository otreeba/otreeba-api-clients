...
void Inline_response_200_4::fromJson(web::json::value& val)
{
    if(val.has_field(U("meta")))
    {
        ...
        {
            std::shared_ptr<Inline_response_200_4_meta> newItem(new Inline_response_200_4_meta());
...
std::shared_ptr<Inline_response_200_4_meta> Inline_response_200_4::getMeta() const
{
    return m_Meta;
}
void Inline_response_200_4::setMeta(std::shared_ptr<Inline_response_200_4_meta> value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
