...
export class FlowersApi {
    ...
    public getFlowerByOcpc(ocpc: string, extraHttpRequestParams?: any): Observable<models.Flower> {
        return this.getFlowerByOcpcWithHttpInfo(ocpc, extraHttpRequestParams)
     ...
     */
    public getFlowers(page?: number, count?: number, sort?: string, extraHttpRequestParams?: any): Observable<models.InlineResponse2004> {
        return this.getFlowersWithHttpInfo(page, count, sort, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
