...
export class EdiblesApi {
     ...
     */
    public getEdibleByOcpc(ocpc: string, extraHttpRequestParams?: any): Observable<models.Edible> {
        return this.getEdibleByOcpcWithHttpInfo(ocpc, extraHttpRequestParams)
     ...
     */
    public getEdibles(page?: number, count?: number, sort?: string, extraHttpRequestParams?: any): Observable<models.InlineResponse2002> {
        return this.getEdiblesWithHttpInfo(page, count, sort, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param ocpc OCPC of the edible to return.
     */
    public getEdibleByOcpcWithHttpInfo(ocpc: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/edibles/${ocpc}`;
     ...
     * @param sort How to sort the items.
     */
    public getEdiblesWithHttpInfo(page?: number, count?: number, sort?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/edibles`;
