...
export class ExtractsApi {
     ...
     */
    public getExtractByOcpc(ocpc: string, extraHttpRequestParams?: any): Observable<models.Extract> {
        return this.getExtractByOcpcWithHttpInfo(ocpc, extraHttpRequestParams)
     ...
     */
    public getExtracts(page?: number, count?: number, sort?: string, extraHttpRequestParams?: any): Observable<models.InlineResponse2003> {
        return this.getExtractsWithHttpInfo(page, count, sort, extraHttpRequestParams)
            .map((response: Response) => {
                if (response.status === 204) {
                    return undefined;
                } else {
     ...
     * @param ocpc OCPC of the extract to return.
     */
    public getExtractByOcpcWithHttpInfo(ocpc: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/extracts/${ocpc}`;
     ...
     * @param sort How to sort the items.
     */
    public getExtractsWithHttpInfo(page?: number, count?: number, sort?: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/extracts`;
